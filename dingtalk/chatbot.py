...
DINGTALK_WEB_HOOK = "https://oapi.dingtalk.com/robot/send?access_token=386077a446fde310ed8c9f54e2b72d225247624019886edac2bc3bc15e69cf72"
DINGTALK_SECRET = "SECee15f0917495c99c4cbf75061bccf63fc0b259b94f64f9557ca010260506d806"

def send_ding(message, et_mobiles=[]):
    webhook = DINGTALK_WEB_HOOK
    xiaoding = DingtalkChatbot(webhook, secret=DINGTALK_SECRET)
    xiaoding.send_text(msg=message, at_mobiles=et_mobiles)
